...
<html>
    <head>
        ...
        <meta name="description" content="A fully featured supervisor theme which can be used to build CRM, CMS, etc.">
        ...
        <div class="wrapper-page">
            <div class="card-box">
                <div class="panel-heading">
                    <h4 class="text-center"> Sign In As <strong class="text-custom">Supervisor</strong></h4>
                </div>
            ...
            @endif
                ...
                <div class="p-20">
                    <form class="form-horizontal m-t-20" method="POST" action="{{route('supervisor.login')}}" enctype="multipart/form-data">
                        @csrf
